...
const SearchFieldWrapper = ({
  ...
  >
    <SearchField.ClearButton className="tw-text-gray-500 tw-w-5 tw-h-5 focus:!tw-shadow-none hover:!tw-bg-transparent hover:!tw-text-gray-500" />
    <SearchField.SubmitButton className="tw-text-gray-500 tw-w-5 tw-h-5 focus:!tw-shadow-none hover:!tw-bg-transparent hover:!tw-text-gray-500" />
